...
from functions.tools.tools_mouse_keyboard import (
...
class TestMouseKeyboardController:
    ...
    @patch('functions.tools.tools_mouse_keyboard.pyautogui.click')
    ...
    @patch('functions.tools.tools_mouse_keyboard.pyautogui.moveTo')
    @patch('functions.tools.tools_mouse_keyboard.pyautogui.position')
    ...
    @patch('functions.tools.tools_mouse_keyboard.pyautogui.scroll')
    ...
    @patch('functions.tools.tools_mouse_keyboard.pyautogui.hscroll')
    ...
    @patch('functions.tools.tools_mouse_keyboard.pyautogui.moveTo')
    @patch('functions.tools.tools_mouse_keyboard.pyautogui.dragTo')
    ...
    @patch('functions.tools.tools_mouse_keyboard.pyautogui.press')
    ...
    @patch('functions.tools.tools_mouse_keyboard.pyautogui.typewrite')
    ...
    @patch('functions.tools.tools_mouse_keyboard.pyautogui.hotkey')
    ...
    @patch('functions.tools.tools_mouse_keyboard.pyautogui.keyDown')
    @patch('functions.tools.tools_mouse_keyboard.pyautogui.keyUp')
    @patch('functions.tools.tools_mouse_keyboard.time.sleep')
    ...
    @patch('functions.tools.tools_mouse_keyboard.pyperclip.copy')
    ...
    @patch('functions.tools.tools_mouse_keyboard.pyperclip.paste')
