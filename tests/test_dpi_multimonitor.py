...
from functions.tools_screen_capture import get_dpi_scaling, get_dpi_scaling_global, ScreenCapture
from functions.tools_mouse_keyboard import _apply_dpi_correction
...
class TestDPIScaling:
    ...
    def test_get_dpi_scaling_no_ctypes(self):
        ...
        with patch("functions.tools_screen_capture.DPI_AVAILABLE", False):
            scaling = get_dpi_scaling()
            assert scaling == 1.0

    @patch("functions.tools_screen_capture.DPI_AVAILABLE", True)
    @patch("functions.tools_screen_capture.ctypes")
    ...
    def test_get_dpi_scaling_global(self):
        ...
        with patch("functions.tools_screen_capture.get_dpi_scaling", return_value=1.5):
...
class TestDPICorrection:
    ...
    def test_apply_dpi_correction_no_scaling(self):
        ...
        with patch("functions.tools_screen_capture.get_dpi_scaling", return_value=1.0):
    ...
    def test_apply_dpi_correction_200_percent(self):
        ...
        with patch("functions.tools_screen_capture.get_dpi_scaling", return_value=2.0):
    ...
    def test_apply_dpi_correction_error(self):
        ...
        with patch("functions.tools_screen_capture.get_dpi_scaling", side_effect=Exception("Error")):
            x, y = _apply_dpi_correction(100, 200)
...
class TestScreenCaptureDPI:
    ...
    @patch("functions.tools_screen_capture.get_dpi_scaling", return_value=1.5)
    @patch("functions.tools_screen_capture.MSS_AVAILABLE", False)
    ...
    @patch("functions.tools_screen_capture.get_dpi_scaling", return_value=1.25)
    @patch("functions.tools_screen_capture.MSS_AVAILABLE", True)
    @patch("functions.tools_screen_capture.mss.mss")
