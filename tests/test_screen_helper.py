...
from functions.tools.screen_helper import (
...
class TestScreenHelper(unittest.TestCase):
    ...
    @patch('functions.tools.screen_helper.ctypes.windll')
    ...
    @patch('functions.tools.screen_helper.get_windows_scale_factor')
    ...
    @patch('functions.tools.screen_helper.PYAUTOGUI_AVAILABLE', False)
    ...
    @patch('functions.tools.screen_helper.pyautogui')
