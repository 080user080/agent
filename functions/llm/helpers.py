...
Транслює виклик ask_llm у нову архітектуру клієнтських ендпоінтів.
"""
...
def ask_llm(prompt: str, system_prompt: str = None, history: list = None) -> str:
    ...
    Транслює виклик у нову архітектуру через get_primary_endpoint() 
    та call_endpoint().
