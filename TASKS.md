Тестове завдання для агента: 
"марк зможе створити код складного типу? Тестове вікно гуі багато вкалдок + на одній чат на іншій налаштування  5 вкладок решту придумай будь що. Зроби тест і запусти"


завдання — створити тестове GUI вікно з вкладками. Агенту Марку потрібно:

Створити новий тестовий файл для GUI з вкладками
Використати PyQt6 (бо проект використовує PyQt6)
Створити вікно з 5+ вкладками
Вкладки: чат, налаштування, + 3 інші (можна придумати: логи, статистика, про програму)
Запустити тест

це останнє на чому зупинилися
