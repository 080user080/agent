...
def main():
    ...
    print("⏳ Зачекайте 1.5  секунди для ініціалізації та фокусу...")   
    time.sleep(1.5)
    
    # 4. Активація вікна агента та вставка тексту (РОБОЧІ МЕТОДИ)
    print("\n📝 Активація вікна агента та вставка тексту 'привіт'...")
    try:
        ...
        # Активуємо вікно агента за назвою (РОБОЧИЙ МЕТОД)
        print("🔓 Активація вікна агента...")
        result = activate_window_by_title(title="МАРК — Асистент (PyQt6)")
        print(f"✅ Вікно активовано: {result}")
        time.sleep(0.8)
        
        # Вставляємо текст (РОБОЧИЙ МЕТОД)
        print("⌨️ Вставка тексту...")
        result = keyboard_type(text="привіт")
        print(f"✅ Текст вставлено: {result}")
        
        # Натискаємо Enter (РОБОЧИЙ МЕТОД)
    ...
    # 5. Затримка для відповіді
    print("⏳ Зачекайте 22 секунди для відповіді...")
    time.sleep(22)
